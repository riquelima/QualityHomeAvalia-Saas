                        ...
                        <div className="mb-4">
                             ...
                             <div className="flex">
                                <input 
                                    ...
                                    className={`w-full p-2 border rounded-l-md ${errors.address ? 'border-red-500' : 'border-medium-border'}`} 
                                    placeholder="Digite o endereço completo ou ajuste no mapa"
                                />
                                <button type="button" onClick={handleLocate} disabled={isLocating} className="bg-primary-text text-white px-4 rounded-r-md flex items-center justify-center w-24 disabled:bg-gray-400">
                                    {isLocating ? (
